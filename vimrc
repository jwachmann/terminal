...
set backspace=eol,start	" allow backspacing over line breaks, allow backspacing over the start of insert; CTRL-W and CTRL-U stop once at the start of insert
